...
namespace IncidentManagement.Services.Tests.DataAccessQueries
{
    public class IncidentQueriesTests
    {
        public static IEnumerable<object[]> InvalidIncidentData =>
            new List<object[]>
            {
                ...
                new object[]
                {
                    new IncidentDto
                    {
                        Occurrence = DateTime.Today.AddDays(1),
                        Location = new LocationDto()
                    }
                }
            };
        ...
        public async Task Add_ShouldAddIncident_IfIncidentValid()
        {
            ...
            Assert.Equal(new DateTime(2000, 12, 25), incident.Occurrence);
        ...
        public async Task Get_ShouldReturnIncidents_IfValidCall()
        {
            ...
            Assert.Equal(incident1.Occurrence, actualIncident1.Occurrence);
            ...
            Assert.Equal(incident2.Occurrence, actualIncident2.Occurrence);
            ...
            Assert.Equal(incident3.Occurrence, actualIncident3.Occurrence);
